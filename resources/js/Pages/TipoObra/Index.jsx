...
import CreateTipoObra from '../../Components/Dashboard/TipoObra/CreateTipoObra';
import EditTipoObra from '../../Components/Dashboard/TipoObra/EditTipoObra';
...
export default function Index(props) {
    ...
    const destroyTipo = () => {
        Inertia.delete(
            route('tipos-obras.destroy', state.id),
                                    ...
                                    <tbody>
                                        {tipos.map((tipo, index) => (
                                            <tr key={tipo.id}>
                                                ...
                                                <td className='text-left'>
                                                    <p className="text-sm font-weight-bold mb-0">{tipo.descricaoTipo}</p>
                                                </td>
...
Index.layout = (page) => <Base key={page} children={page} title={"Tipos de Obras"}/>
